...
class EmbeddingGenerator:
    ...
    def __init__(self, model_name: str = "mlx-community/Qwen3-0.6B-4bit"):
        """
...
def get_embedding_generator(model_name: str = "mlx-community/Qwen3-0.6B-4bit") -> EmbeddingGenerator:
    """
